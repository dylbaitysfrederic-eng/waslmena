    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b bg-background py-12">
        <div className="mx-auto max-w-screen-xl px-4">
          <div className="max-w-2xl">
            <p className="text-sm font-semibold uppercase text-emerald-700">
              {t('product_preview_eyebrow')}
            </p>
            <h2 className="mt-2 text-3xl font-semibold tracking-normal text-zinc-950">
              {t('product_preview_title')}
            </h2>
            <p className="mt-3 text-sm leading-6 text-muted-foreground sm:text-base">
              {t('product_preview_description')}
            </p>
          </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-md border bg-zinc-950 p-4 text-white">
                <div className="flex min-h-72 flex-col justify-between rounded-lg border border-white/15 bg-[linear-gradient(160deg,#064e3b,#111827_62%)] p-4">
                  <div>
                    ...
                    <p className="mt-4 text-sm font-semibold uppercase text-emerald-100">
                      {t('product_preview_welcome_screen_title')}
                    </p>
                    <h3 className="mt-2 text-2xl font-semibold">Bistro Beirut</h3>
                  </div>
                  <div className="rounded-md bg-white px-4 py-3 text-center text-sm font-bold text-zinc-950">
                    Open Menu
                  </div>
                </div>
                <p className="mt-3 text-sm leading-6 text-zinc-300">
                  {t('product_preview_welcome_screen_description')}
                </p>
              </div>
              ...
              <div className="rounded-md border bg-white p-4">
                <div className="rounded-md border bg-zinc-950 p-2">
                  <div className="rounded-md bg-white p-3 text-zinc-950">
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-xs font-semibold uppercase text-emerald-700">
                          {t('product_preview_mobile_menu_title')}
                        </div>
                        <div className="font-semibold">{t('phone_category')}</div>
                      </div>
                      <Languages className="size-4 text-emerald-700" />
                    </div>
                    <div className="mt-3 grid gap-2">
                      {[t('phone_item'), t('template_sample_item')].map((item, index) => (
                        <div key={item} className="rounded-md border p-3">
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <div className="text-sm font-semibold">{item}</div>
                              <div className="mt-1 text-xs text-muted-foreground">
                                {index === 0 ? t('phone_item_note') : t('customer_menu_label')}
                              </div>
                            </div>
                ...
                <p className="mt-3 text-sm leading-6 text-muted-foreground">
                  {t('product_preview_mobile_menu_description')}
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-4">
              <div className="rounded-md border bg-zinc-950 p-4 text-white">
                <div className="flex items-center justify-between gap-3 border-b border-zinc-800 pb-3">
                  <div>
                    <h3 className="text-lg font-semibold">
                      {t('product_preview_orders_dashboard_title')}
                    </h3>
                    <p className="text-xs text-zinc-400">
                      {t('product_preview_orders_dashboard_description')}
                    </p>
                  </div>
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  {OWNER_EXAMPLES.slice(0, 2).map(({ orderId, guest, table, itemKey }) => (
                    <div key={orderId} className="rounded-md border border-zinc-800 bg-zinc-900 p-3">
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          <div className="font-semibold">{orderId}</div>
                      ...
                      <div className="mt-3 text-sm text-zinc-300">{t(itemKey)}</div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-md border bg-white p-4">
                  ...
                  <p className="mt-1 text-sm leading-6 text-muted-foreground">
                    {t('product_preview_ticket_description')}
                  </p>
                  <div className="mt-4 rounded-lg border bg-zinc-50 p-3 font-mono text-xs text-zinc-900">
                    <div className="text-center font-bold">BISTRO BEIRUT</div>
                    <div className="mt-2 flex justify-between border-y py-2">
                      <span>#104</span>
                      <span>TABLE 7</span>
                    </div>
                    <div className="mt-2 grid gap-2">
                      <div className="flex justify-between gap-3">
                        ...
                        <span className="flex-1">{t('phone_item')}</span>
                      </div>
                      <div className="rounded bg-white p-2 text-[11px]">
                        {t('phone_item_note')}
                      </div>
                    </div>
                    <div className="mt-3 border-t pt-2 text-center font-bold">
                      {t('product_preview_print_ready')}
                    </div>
                  </div>
                </div>
              </div>
