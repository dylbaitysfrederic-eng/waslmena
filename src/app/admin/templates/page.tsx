    ...
    <section className="grid gap-4">
      <div className="rounded-md bg-background p-5">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          ...
          Day-to-day menu and table edits remain in the restaurant dashboard.
        </p>
        <p className="mt-2 text-sm text-muted-foreground">
          These settings can be changed later. They do not rename organizations,
          delete tables, rotate QR codes, or change existing public table menu URLs.
        </p>
      </div>
